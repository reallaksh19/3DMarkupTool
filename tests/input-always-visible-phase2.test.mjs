...
assert.match(pkg.scripts.test, /input-always-visible-phase2\.test\.mjs/, 'npm test must include the Phase 2 input visibility gate.');

console.log('input always-visible Phase 2 gate passed');
