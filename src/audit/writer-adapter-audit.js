...
const COUNT_KEYS = [
  'rvmPlannedChunkCount',
  'rvmPlannedPrimChunkCount',
  'rvmPlannedCylinderCount',
  'rvmPlannedTorusCount',
  'rvmPlannedBoxCount',
  'rvmPlannedSphereCount',
  'rvmPlannedPyramidCount',
  'attPlannedRecordCount',
  'glbPlannedVisualCount',
  'blockedWriterItemCount',
  'deferredWriterItemCount',
  'blockedUnresolvedWriterCount',
...
export function assertWriterAdapterAudit(audit, expectations = {}) {
  ...
  for (const key of ['rvmWriterReady', 'attWriterReady', 'glbWriterReady', 'ok']) {
