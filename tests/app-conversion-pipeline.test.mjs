...
function makeLegacyGlbResult() {
  return {
    ...
    audit: { componentCount: 2, nodeCount: 3, supportSymbols: [], diagnostics: [] },
    model: {
      sourceKind: 'InputXML',
      elements: [
        {
  ...
  return {
    ...
    convertInputXmlToRvmAtt(sourceText, options) {
      ...
      return {
        ...
        att: 'NEW ROOT\nEND\n',
        audit: { componentCount: 2, supportCount: 1, primitiveCount: 2, annotationCount: 0 },
