...
assert.equal(assertDiagnosticCanvasPreviewAudit(state.diagnosticPreviewAudit, { ok: true, previewItemCount: 52, straightPipeByteProvenPreviewCount: 19, bendTorusPrimitiveResolvedPreviewCount: 7, bendTorusByteProvenPreviewCount: 7, bendTorusWriterDeferredPreviewCount: 0, flangePrimitiveResolvedPreviewCount: 8, flangeWriterDeferredPreviewCount: 8, blockedComponentPreviewCount: 6, blockedFlangePreviewCount: 0, blockedValvePreviewCount: 6, blockedBendPreviewCount: 0, deferredSupportPreviewCount: 12, sourceTraceCount: 52, geometryPayloadCount: 0, meshPayloadCount: 0, threeObjectCount: 0, objectUrlCount: 0, downloadSideEffectCount: 0, binaryPayloadCount: 0, textPayloadCount: 0, glbPayloadCount: 0, cacheKeyMutationCount: 0 }).ok, true);
