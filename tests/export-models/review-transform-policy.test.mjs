...
assert.deepEqual(transformed.center, [-300, -100, 200], 'primitive center finite and transformed');
assert.deepEqual(transformed.axis, [-0.8, 0, 0.6], 'primitive axis finite and normalized');
