...
assert.match(bootstrap, /esc-tools-export-icons-20260619/, 'safe bootstrap cache key must bump for measure polyline and the current ESC/export/icon tool pack');
