...
const COUNT_KEYS = ['rvmTransformWarningCount', 'rvmPrimitivePlanCount', 'rvmCylinderPlanCount', 'rvmTorusPlanCount', 'rvmTorusWriterReadyCount', 'testByteEligibleTorusCount', 'testByteEligibleBendTorusCount', 'productionReadyTorusCount', 'deferredBendTorusExportCount', 'rvmBoxPlanCount', 'rvmSpherePlanCount', 'rvmPyramidPlanCount', 'attRecordPlanCount', 'glbVisualPlanCount', 'blockedExportCount', 'deferredExportCount', 'blockedAttRecordCount', 'deferredAttRecordCount', 'blockedVisualCount', 'deferredVisualCount', 'blockedUnresolvedExportCount', 'blockedFlangeExportCount', 'blockedValveExportCount', 'blockedBendExportCount', 'deferredSupportExportCount', 'writerCallCount', 'binaryPayloadCount', 'textPayloadCount', 'glbPayloadCount', 'hardErrorCount'];
