...
assert.match(bootstrap, /workflow-input-expanded-load-controls-20260625/, 'input final-state controller must use the expanded load-controls cache key');
...
console.log('input panel workflow-revamp final-state expanded-load-controls gate passed');
