  ...
  hierarchy: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            support('INPUTXML-10-REST', 'ATTA', 'REST', '10', { x: 0, y: 0, z: 0 }),
            support('INPUTXML-20-GUIDE', 'ANCI', 'GUIDE', '20', { x: 1000, y: 0, z: 0 }),
            support('INPUTXML-20-LINESTOP', 'SUPPORT', 'LINESTOP', '20', { x: 1000, y: 0, z: 0 })
          ]
        }
      ]
    }
...
function support(name, type, kind, node, pos) {
  return {
    name: `SUPPORT ${name}`,
    type,
    attributes: {
