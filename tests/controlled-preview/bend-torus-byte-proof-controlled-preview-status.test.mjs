...
assert.equal(state.controlledPreviewModel.artifactReadiness.flangeByteProvenCount, 8);
assert.equal(state.controlledPreviewModel.artifactReadiness.flangeWriterDeferredCount, 0);
