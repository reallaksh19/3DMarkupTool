...
assert.match(index, /input-always-visible-20260619|phase4-global-esc-lifecycle-20260619|phase4a-static-input-panel-cleanup-20260619/, 'Index must use the Phase 2 or newer cache key.');
...
assert.match(bootstrap, /SAFE_UI_VERSION = '(input-always-visible-20260619|phase3-ribbon-cleanup-20260619|phase4-global-esc-lifecycle-20260619|phase4a-static-input-panel-cleanup-20260619)'/, 'Bootstrap must use the Phase 2 or newer cache key.');

assert.match(controller, /const VERSION = 'phase4a-static-input-panel-cleanup-20260619'/, 'Controller must declare Phase 4A compact cleanup version.');
...
assert.match(controller, /flex-wrap:\s*nowrap\s*!important/, 'Input primary actions must remain in one compact row.');
...
assert.match(collapseController, /data-collapsible=\"sideload\"/, 'Sideload collapse must be marker-based, not positional.');
...
console.log('input always-visible Phase 2 / Phase 4A gate passed');
