...
const activeBmCiiCacheKey = 'bm-cii-code8-support-export-20260622';
...
assert.match(index, new RegExp(activeBmCiiCacheKey));
assert.doesNotMatch(index, /fresh-clip-core-20260619/);
assert.match(index, new RegExp(`safe-ui-bootstrap\\.js\\?v=${activeBmCiiCacheKey}`));
