...
assert.equal(exportResult.audit.inputXmlNodeLocalElbowAudit.nodeLocalElbowCount, 7);
assert.equal(exportResult.audit.inputXmlNodeLocalElbowAudit.genericNodeLocalElbowPrimitiveCount, 28);
