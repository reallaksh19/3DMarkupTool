const STARTUP_SIDE_EFFECT_MODULES = [
  ...
  './rvm-viewer/RvmInputXmlSupportGraphicsSetModelBridge.js?v=20260625-rvm-standalone-support-overlay-clean-1',
...
// Active cache key: core/app.js?v=20260625-rvm-standalone-support-overlay-clean-1
...
try {
  await import('./core/app.js?v=20260625-rvm-standalone-support-overlay-clean-1');
