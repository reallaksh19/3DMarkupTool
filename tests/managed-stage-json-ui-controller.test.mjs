...
assert.match(controller, /primitiveCodeCounts:\s*\{\s*1:\s*0,\s*4:\s*0,\s*8:\s*133\s*\}/);
assert.match(controller, /code1:\s*0/);
assert.match(controller, /cntbCount:\s*56/);
assert.match(controller, /primCount:\s*133/);
...
console.log('stagedJson UI uses coordinate-preserving preview pipeline, support visual resolver, compact code-8 support-bar RVM contract, and non-blocking UI warnings');
