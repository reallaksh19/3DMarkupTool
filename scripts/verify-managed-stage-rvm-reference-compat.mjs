...
function requireBmCiiCounts(generated, audit, issues) {
  ...
  requireEqual(generated.primitiveHistogram['8'] || 0, 91, 'BM_CII code 8 primitive count', issues);
  requireEqual(generated.binary.counts.CNTB || 0, 43, 'BM_CII CNTB count', issues);
  requireEqual(generated.binary.counts.PRIM || 0, 91, 'BM_CII PRIM count', issues);
  ...
  requireEqual(audit.inputXmlBendExclusionAudit?.genericCode8BendPrimitiveCount || 0, 35, 'BM_CII generic bend primitive count', issues);
