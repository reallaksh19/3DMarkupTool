...
assert.match(dispatch, /api\.activate = \(\) => activateAreaSelect\(\)/);
...
assert.match(pkg.scripts.test, /glb-support-restraint-scene-audit\.test\.mjs/, 'C17 core audit gate must be preserved.');
