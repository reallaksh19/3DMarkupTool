...
assert.match(controller, /primitiveCodeCounts:\s*\{\s*1:\s*17,\s*4:\s*0,\s*8:\s*99\s*\}/);
assert.match(controller, /code1:\s*17/);
...
console.log('unified InputXML / managed-stage JSON UI uses coordinate-preserving preview pipeline, support visual resolver, compact support-cone RVM contract, and non-blocking UI warnings');
